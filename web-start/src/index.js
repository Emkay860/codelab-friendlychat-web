...
function loadMessages() {
  ...
  // Create the query to load last 12 messages and listen for new ones
...
async function saveImageMessage(file) {
  ...
  try {
    // Add a message with a loading icon that will get updayed with the shared image
    ...
    // Update he chat message placeholder with the image's URL
...
async function saveMessagingDeviceToken() {
  ...
  try {
    ...
    if (currentToken) {
      ...
      onMessage(getMessaging(), (messsage) => {
        console.log(
